"use strict";Object.defineProperty(exports, "__esModule", {value: true});/* eslint-disable no-underscore-dangle */
...
const XPlaneClient = function constructor(settings) {
  ...
  this.requestDataRef = function requestDataRef(
    ...
    const buffer = _buffer.Buffer.alloc(5 + 4 + 4 + 400);
  ...
  this.setDataRef = function setDataRef(dataRef, value) {
    const buffer = _buffer.Buffer.alloc(509, 0x20);
  ...
  this.sendCommand = function sendCommand(command) {
    const buffer = _buffer.Buffer.alloc(5 + command.length + 1);
  ...
  this.initConnection = function initConnection() {
    if (client === null) {
      client = _dgram.createSocket.call(void 0, 'udp4');
    } else {
      return;
    }
